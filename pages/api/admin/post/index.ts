...
import { findPostReports, findPostReportsCount } from "@/utils/report";
...
async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        const count = await findPostReportsCount(showHidden === "false");
        ...
        const results = await findPostReports(skip, take, showHidden === "false");
