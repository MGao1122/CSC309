...
import { findTemplateReports, findTemplateReportsCount } from "@/utils/report";
...
async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        const count = await findTemplateReportsCount(showHidden === "false");
        ...
        const results = await findTemplateReports(skip, take, showHidden === "false");
