...
export function ReportCommentButton({ id, type, className="" }: ReportButtonProps) {
    ...
    return (
        <Popover>
            <PopoverTrigger asChild>
                <Button variant="link" size="sm" className={className}><MessageCircleWarning color="#ff0000"/></Button>
            </PopoverTrigger>
